<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-gray-50 dark:bg-gray-800" aria-label="Sidebar" style="width: 20vw;height: 100vh">
   <div class="h-full flex flex-col items-center px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800" style="height: 100vh">
      ...
      <ul class="space-y-4 mt-6 font-medium">
         ...
         <li>
            <a class="self-start mt-2 p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <span>Location</span>
            </a>
         </li>
         <li>
            ...
            <div class="hidden  sm:flex sm:items-center sm:ml-6 relative">
                <x-dropdown alignment="right-end" width="48">
                    <x-slot name="trigger">
